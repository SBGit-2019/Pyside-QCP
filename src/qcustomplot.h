// NOTE: This is a temporary copy from the original QCustomPlot 2.1 source
//       file with some minor patches necessary for the bindings creation. 
/***************************************************************************
**                                                                        **
...
public:
  ...
  virtual double selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=nullptr) const Q_DECL_OVERRIDE   {return 0.0;} // actually introduced in QCPLayerable as non-pure, but we want to force reimplementation for plottables
...
public:
  ...
  virtual double selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=nullptr) const Q_DECL_OVERRIDE {return 0.0;};
...
public:
  ...
  */
  ...
  void setLabel(const QString &str);
  void setLabelPadding(int padding);
  // PYSIDE2-FIX: Implementation missing?
